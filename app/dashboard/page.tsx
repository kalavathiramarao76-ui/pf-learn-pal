...
export default function DashboardPage() {
  ...
  const makeAiRecommendation = async () => {
    if (aiModel) {
      ...
      const userInputTensor = tf.tensor2d([userInput], [1, 3]);
      const output = aiModel.predict(userInputTensor);
    ...
    <DashboardLayout>
      <div className="container">
        ...
        <div className="row">
          ...
          <div className="col-md-4">
            <CommunityCard title="Community" link="/community" />
          </div>
        </div>
        <div className="row">
          <div className="col-md-4">
            <ResourceCard title="Resources" link="/resources" />
          </div>
          <div className="col-md-4">
